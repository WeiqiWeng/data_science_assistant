import data_preprocessor as dsa
import pandas as pd
import numpy as np
...
data = ds_assist.batch_dummy_encode_catagorical_variable(data, ['marital', 'contact'])
print(list(data))

value_to_proportion = ds_assist.proportion_of_level_catagorical_variable(train_set_y, True)

print(value_to_proportion)
